...
set showcmd                         " show command line in the bottom
set autoindent                      " automatically indent new line as previous one
...
set shortmess+=c                    " won't show matches when auto-completing
...
set splitbelow                      " Open new slit below current one
set splitright                      " Open new vert split on a right of current one
...
nnoremap <leader>ee :e ++enc=
nnoremap <leader>u :UndotreeToggle<Return>
nnoremap <leader>t :terminal ++rows=25<Return>
"FZF search
...
"Delete preview window from buffer after it's closed
autocmd CompleteDone * if !pumvisible() | pclose | endif

imap <C-c> <C-x><C-o>
inoremap <silent><S-Tab> <c-r>=UpwardCompleteByTab()<CR>
inoremap <silent><Tab> <c-r>=DownwardCompleteByTab()<CR>
inoremap <silent><C-k> <c-r>=UpwardCompleteByCJ()<CR>
inoremap <silent><C-j> <c-r>=DownwardCompleteByCK()<CR>
"+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
